    ...
    <>
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-24 text-center lg:py-56">
          ...
          <p className="mb-8 text-lg font-normal text-gray-300 sm:px-16 lg:px-48 lg:text-xl">
            Nuestra aplicación web es una herramienta discreta pero poderosa
            diseñada para facilitar el proceso de dropshipping ayudando a
            conseguir productos ganadores.
          </p>
